...
const BankModal: React.FC<BankModalProps> = ({ isOpen, formData, setFormData, setMethods, setError, onClose, initialFormState }) => {
        ...
        <form onSubmit={handleBankSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={e => setFormData((f: any) => ({ ...f, accountNumber: e.target.value }))}
              required
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={e => setFormData((f: any) => ({ ...f, bankName: e.target.value }))}
              required
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={e => setFormData((f: any) => ({ ...f, ifscCode: e.target.value }))}
              required
            />
          </div>
