            ...
            <div>
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-white">{creatorData.basicDetails.mobile}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400">Email address</span>
                  <span className="text-white">{creatorData.basicDetails.email}</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-white">{creatorData.appInteraction.totalStreamHours}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400">Report</span>
                  <span className="text-white">{creatorData.appInteraction.reports}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400">Avg viewers per stream</span>
                  <span className="text-white">{creatorData.appInteraction.avgViewersPerStream}</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4 text-sm">
                <div className="flex justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center">
                      ...
                      <span>{creatorData.moreDetails.interactions.comments}</span>
                    </div>
                    <div className="flex items-center">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-white">{creatorData.moreDetails.followers}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400">Total private chat</span>
                  <span className="text-white">{creatorData.moreDetails.privateChats}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400">Total private calls</span>
                  <span className="text-white">{creatorData.moreDetails.privateCalls}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400">Gifts received per private chat</span>
                  <span className="text-white">{creatorData.moreDetails.giftsPerPrivateChat}</span>
                </div>
              </div>
            </div>
