    ...
    <div className="w-full bg-black text-white overflow-auto">
      <div className="border-white/15 border-b-2 w-full p-4 pb-1 flex justify-between  items-center">
        ...
        <div className="flex items-center gap-10">
          ...
          <p className="text-[#1A88FF] underline cursor-pointer text-lg pr-2">Send feedback</p>
        </div>
      </div>
        ...
        <div className="flex gap-x-4">
          ...
          <div className="w-full h-[32vh] gap-3 flex">
            ...
            <div className="w-1/3 h-full bg-[#1e1e1e] rounded-2xl pb-3 flex flex-col">
              ...
              {[...Array(7)].map((_, index)=><div key={index} className="flex px-8 justify-between max-lg:px-2 my-2  text-[0.7vw]">
                <div className="w-[8%] flex"><Image src={badge} alt="medal" className="object-fill"></Image></div>
